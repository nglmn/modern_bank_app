...
const Billing = () => (
    <section id='product' className={layout.sectionReverse}>
        <div className={layout.sectionReverse}>
            <img src={bill} alt="billing" className="w-[55%] h-[100%] relative z-[5]" />

            <div className="absolute z-[0] -left-1/2 top-0 w-[50%] h-[50%] rounded-full white__gradient" />
            <div className="absolute z-[0] -left-1/2 bottom-0 w-[50%] h-[50%] rounded-full pink__gradient" />
            <div className="absolute z-[0] -left-1/2 w-[50%] h-[50%] -left-[50%] rounded-full white__gradient" />

            <div className={`${layout.sectionInfo} ml-15`}>
